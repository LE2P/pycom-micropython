# from : https://github.com/robmarkcole/bme680-mqtt-micropython/blob/master/lib/bme680.py
'''
This file is dedicated to manage the BME680 used by Usecase 1
The I2C communication is used, but an SPI implementation could be

'''

from lib.drivers.bme680.bme680_data import *
